...
Globals.order_post_path_verify = Globals_1._get_path('order/order-callback-front/');
...
var BodyComponent = (function () {
    ...
    BodyComponent.prototype.check_filter_add = function (tag) {
        if (this.filter_object.getElement(tag) === 1)
            return true;
        return false;
    };
    BodyComponent.prototype.check_filter_remove = function (tag) {
        if (this.filter_object.getElement(tag) === -1)
            return true;
        return false;
    };
    ...
    BodyComponent.prototype.hasMutual = function (array_1, array_2) {
        for (var _i = 0, array_1_1 = array_1; _i < array_1_1.length; _i++) {
            var el = array_1_1[_i];
            if (array_2.includes(el))
                return true;
        }
        return false;
    };
            ...
            if (response['message'] === 'success') {
                ...
                window.LiqPayCheckoutCallback = function () {
                    _liqPayCheckout_1.init({
                        ...
                        console.log(data);
                        // this.http.post(this.globals.order_post_path_verify, data, {headers: this.headers});
...
var HeaderComponent = (function () {
    ...
    HeaderComponent.prototype.get_categories = function (first_time) {
        ...
        this.http.get(this.globals.categories_get_path, { headers: this.headers })
            ...
            var tmp_products = {};
            _this.bottom_nav_list = _this.globals.categories;
            ...
            if (first_time)
                _this.change_categories(_this.globals.categories[0].id);
        }, function (error) {
            console.log('ERROR: ', error);
        });
    };
    HeaderComponent.prototype.change_categories = function (id) {
        this.globals.current_page = { 'title': 'main' };
